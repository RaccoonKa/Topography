...
var
  Formcorners25k: TFormcorners25k;
...
procedure TFormcorners25k.FormShow(Sender: TObject);
begin
  DoubleBuffered := True;
  zoom := 1;
  Lzoom := 2.93;
  ...
  Image := TGPBitmap.Create('..\data\ygli\assets\maps\map25k.jpg');
  ...
  ScrollBox1.HorzScrollBar.Position := (Image1.Width div 2) - (ScrollBox1.ClientWidth div 2);
  ScrollBox1.VertScrollBar.Position := (Image1.Height div 2) - (ScrollBox1.ClientHeight div 2);
...
procedure TFormcorners25k.FormDestroy(Sender: TObject);
begin
  Pen.Free;
  SolidBrush.Free;
  graphicsGDIPlus.Free;
...
procedure TFormcorners25k.Image1MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
  if Tr then
  begin
...
procedure TFormcorners25k.Image1MouseMove(Sender: TObject; Shift: TShiftState; X,
  Y: Integer);
begin
  MouseX := X;
  MouseY := Y;
...
procedure TFormcorners25k.Image1MouseUp(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
...
procedure TFormcorners25k.LPaint;
begin
  T1 := Now;
  graphicsGDIPlus := TGPGraphics.Create(Image1.Canvas.Handle);
  ...
  begin
    ...
    graphicsGDIPlus.DrawImage(znak2, Round(FixFX * zoom) - 5, Round(FixFY * zoom) - 5, 10, 10);
    graphicsGDIPlus.DrawLine(pen, Round(FixFX * zoom), Round(FixFY * zoom),
      Round(FixFX2 * zoom), Round(FixFY2 * zoom));
  end;
  ...
  Caption := (IntToStr(s) + ':' + IntToStr(ms) + '  ' + IntToStr(MouseX) + 'x' + IntToStr(MouseY) +
    '  ' + FloatToStrF((4308 + ((MouseX / zoom - x1) * xx1 / det + (MouseY / zoom - y1) * yy1 / det)), ffFixed, 8, 1) + 'x' +
         FloatToStrF((6070 - ((MouseX / zoom - x1) * xx2 / det + (MouseY / zoom - y1) * yy2 / det)), ffFixed, 8, 1) +
...
procedure TFormcorners25k.SpeedButton1Click(Sender: TObject);
begin
  whatDraw := 'Z1';
  Tr := False;
end;

procedure TFormcorners25k.SpeedButton1MouseEnter(Sender: TObject);
begin
  SpeedButton1.Glyph.LoadFromFile('..\data\ygli\assets\green/Btn2New2.bmp');
end;

procedure TFormcorners25k.SpeedButton1MouseLeave(Sender: TObject);
begin
  SpeedButton1.Glyph.LoadFromFile('..\data\ygli\assets\green/Btn2New1.bmp');
end;

procedure TFormcorners25k.SpeedButton2Click(Sender: TObject);
begin
  instructions.Forminstructions.Visible := True;
end;

procedure TFormcorners25k.SpeedButton2MouseEnter(Sender: TObject);
begin
  SpeedButton2.Glyph.LoadFromFile('..\data\ygli\assets\green\12.bmp');
end;

procedure TFormcorners25k.SpeedButton2MouseLeave(Sender: TObject);
begin
  SpeedButton2.Glyph.LoadFromFile('..\data\ygli\assets\green\11.bmp');
end;

procedure TFormcorners25k.SpeedButton3Click(Sender: TObject);
begin
  about_program.Formprogram.Visible := True;
end;

procedure TFormcorners25k.SpeedButton3MouseEnter(Sender: TObject);
begin
  SpeedButton3.Glyph.LoadFromFile('..\data\ygli\assets\green\32.bmp');
end;

procedure TFormcorners25k.SpeedButton3MouseLeave(Sender: TObject);
begin
  SpeedButton3.Glyph.LoadFromFile('..\data\ygli\assets\green\31.bmp');
end;

procedure TFormcorners25k.FormKeyPress(Sender: TObject; var Key: Char);
begin
  if (key = '+') then
  begin
    zoom := zoom * 1.1;
...
procedure TFormcorners25k.FormMouseWheelDown(Sender: TObject; Shift: TShiftState;
  MousePos: TPoint; var Handled: Boolean);
begin
...
procedure TFormcorners25k.FormMouseWheelUp(Sender: TObject; Shift: TShiftState;
  MousePos: TPoint; var Handled: Boolean);
begin
  if Tr or (whatDraw = 'L') or FixL then
  begin
...
procedure TFormcorners25k.BexitKeyPress(Sender: TObject; var Key: Char);
begin
  FormKeyPress(self, key);
end;

procedure TFormcorners25k.BexitMouseEnter(Sender: TObject);
begin
  Bexit.Glyph.LoadFromFile('..\data\ygli\assets\green/Btnexitgreen2.bmp');
end;

procedure TFormcorners25k.BexitMouseLeave(Sender: TObject);
begin
  Bexit.Glyph.LoadFromFile('..\data\ygli\assets\green/Btnexitgreen.bmp');
end;

procedure TFormcorners25k.BFlagClick(Sender: TObject);
begin
  whatDraw := 'F';
  Image1.Cursor := crNone;
end;

procedure TFormcorners25k.BFlagKeyPress(Sender: TObject; var Key: Char);
begin
  FormKeyPress(self, Key);
end;

procedure TFormcorners25k.BitBtn1Click(Sender: TObject);
begin
...
procedure TFormcorners25k.BitBtn1KeyPress(Sender: TObject; var Key: Char);
begin
  FormKeyPress(self, Key);
end;

procedure TFormcorners25k.BexitClick(Sender: TObject);
begin
  Close;
end;

procedure TFormcorners25k.BhideClick(Sender: TObject);
begin
...
procedure TFormcorners25k.BhideMouseEnter(Sender: TObject);
begin
  Bhide.Glyph.LoadFromFile('..\data\ygli\assets\green/Bhide2.bmp');
end;

procedure TFormcorners25k.BhideMouseLeave(Sender: TObject);
begin
  Bhide.Glyph.LoadFromFile('..\data\ygli\assets\green/Bhide1.bmp');
end;

procedure TFormcorners25k.BTestClick(Sender: TObject);
var
  i, j, q: integer;
  text: string;
  a, d, m: double;
...
begin
  ...
  if Length(ComboBox2.Text) <> 0 then
    dat[4] := (StrToInt(ComboBox2.Text) - 1965) / 60
  else
  begin
    ComboBox2.Text := '2015';
    dat[4] := (2015 - 1965) / 60;
  ...
  ShowMessage(
    ...
    'Магнитный азимут (1965 г.)      ' + R[3][1] + '° ' + R[3][2] + #39 + R[3][3] + '° ' + R[3][4] + #39 + R[3][5] + #13#10 +
    'Изменение м-го азимута           ' + R[4][1] + '° ' + R[4][2] + #39 + R[4][3] + '° ' + R[4][4] + #39 + R[4][5] + #13#10
  );
end;

procedure TFormcorners25k.BTestKeyPress(Sender: TObject; var Key: Char);
begin
...
procedure TFormcorners25k.Bznak1Click(Sender: TObject);
begin
  Self.ActiveControl := nil;
  whatDraw := 'Z1';
end;

procedure TFormcorners25k.Bznak1MouseEnter(Sender: TObject);
begin
  Bznak1.Glyph.LoadFromFile('..\data\ygli\assets\green/Flag12.bmp');
end;

procedure TFormcorners25k.Bznak1MouseLeave(Sender: TObject);
begin
  Bznak1.Glyph.LoadFromFile('..\data\ygli\assets\green/Flag11.bmp');
end;

procedure TFormcorners25k.Bznak2Click(Sender: TObject);
begin
  whatDraw := 'Z2';
  Self.ActiveControl := nil;
end;

procedure TFormcorners25k.Bznak2MouseEnter(Sender: TObject);
begin
  Bznak2.Glyph.LoadFromFile('..\data\ygli\assets\green/Flag22.bmp');
end;

procedure TFormcorners25k.Bznak2MouseLeave(Sender: TObject);
begin
  Bznak2.Glyph.LoadFromFile('..\data\ygli\assets\green/Flag21.bmp');
end;

procedure TFormcorners25k.Bznak3Click(Sender: TObject);
begin
  whatDraw := 'Z3';
  Self.ActiveControl := nil;
end;

procedure TFormcorners25k.Bznak4Click(Sender: TObject);
begin
  whatDraw := 'Z4';
  Self.ActiveControl := nil;
end;

procedure TFormcorners25k.Bznak4MouseEnter(Sender: TObject);
begin
  Bznak4.Glyph.LoadFromFile('..\data\ygli\assets\green/Flag42.bmp');
end;

procedure TFormcorners25k.Bznak4MouseLeave(Sender: TObject);
begin
  Bznak4.Glyph.LoadFromFile('..\data\ygli\assets\green/Flag41.bmp');
end;

procedure TFormcorners25k.ComboBox1KeyPress(Sender: TObject; var Key: Char);
begin
  if (Key > #31) and (not CharInSet(Key, ['0'..'9'])) and (Key <> #44) and (Key <> #46) then
  begin
    FormKeyPress(self, key);
...
procedure TFormcorners25k.ComboBox2KeyPress(Sender: TObject; var Key: Char);
begin
...
function TFormcorners25k.CtrlDown: Boolean;
var
...
procedure TFormcorners25k.Edit1KeyPress(Sender: TObject; var Key: Char);
begin
  if (Key > #31) and (not CharInSet(Key, ['0'..'9'])) and (Key <> #44) and (Key <> #46) then
  begin
    FormKeyPress(self, key);
...
procedure TFormcorners25k.Edit2KeyPress(Sender: TObject; var Key: Char);
begin
  if (Key > #31) and (not CharInSet(Key, ['0'..'9'])) and (Key <> #44) and (Key <> #46) then
  begin
    FormKeyPress(self, key);
...
procedure TFormcorners25k.Edit3KeyPress(Sender: TObject; var Key: Char);
begin
  if (Key > #31) and (not CharInSet(Key, ['0'..'9'])) and (Key <> #44) and (Key <> #46) then
  begin
    FormKeyPress(self, key);
...
procedure TFormcorners25k.Edit4KeyPress(Sender: TObject; var Key: Char);
begin
  if (Key > #31) and (not CharInSet(Key, ['0'..'9'])) and (Key <> #44) and (Key <> #46) then
  begin
    FormKeyPress(self, key);
...
procedure TFormcorners25k.Edit5KeyPress(Sender: TObject; var Key: Char);
begin
  if (Key > #31) and (not CharInSet(Key, ['0'..'9'])) and (Key <> #44) and (Key <> #46) then
  begin
    FormKeyPress(self, key);
