...
Panel1.Color:=RGB(31,21,5);
 ...
 Image:= TGPBitMap.Create('..\data\ygli\assets\maps\map100k.jpg');
...
procedure TFormcorners100k.SpeedButton1MouseEnter(Sender: TObject);
begin
  SpeedButton1.Glyph.LoadFromFile('..\data\ygli\assets\green/Btn2New2.bmp');
end;

procedure TFormcorners100k.SpeedButton1MouseLeave(Sender: TObject);
begin
  SpeedButton1.Glyph.LoadFromFile('..\data\ygli\assets\green/Btn2New1.bmp');
end;

procedure TFormcorners100k.SpeedButton2Click(Sender: TObject);
begin
  instructions.Forminstructions.Visible:=true;
end;

procedure TFormcorners100k.SpeedButton2MouseEnter(Sender: TObject);
begin
  SpeedButton2.Glyph.LoadFromFile('..\data\ygli\assets\green\12.bmp');
end;

procedure TFormcorners100k.SpeedButton2MouseLeave(Sender: TObject);
begin
  SpeedButton2.Glyph.LoadFromFile('..\data\ygli\assets\green\11.bmp');
end;

procedure TFormcorners100k.SpeedButton3Click(Sender: TObject);
begin
  about_program.Formprogram.Visible:=true;
end;

procedure TFormcorners100k.SpeedButton3MouseEnter(Sender: TObject);
begin
  SpeedButton3.Glyph.LoadFromFile('..\data\ygli\assets\green\32.bmp');
end;

procedure TFormcorners100k.SpeedButton3MouseLeave(Sender: TObject);
begin
  SpeedButton3.Glyph.LoadFromFile('..\data\ygli\assets\green\31.bmp');
end;
...
procedure TFormcorners100k.BexitMouseEnter(Sender: TObject);
begin
  Bexit.Glyph.LoadFromFile('..\data\ygli\assets\green/Btnexitgreen2.bmp');
end;

procedure TFormcorners100k.BexitMouseLeave(Sender: TObject);
begin
  Bexit.Glyph.LoadFromFile('..\data\ygli\assets\green/Btnexitgreen.bmp');
end;
...
procedure TFormcorners100k.BTestClick(Sender: TObject);
var
  i, j, q: integer;
  text: string;
  a, d, m: double;
...
begin
  ...
  if Length(ComboBox1.Text) <> 0 then
    dat[4] := (StrToInt(ComboBox2.Text) - 1983) / 60
  else
  begin
    ComboBox2.Text := '2015';
    dat[4] := (2015 - 1983) / 60;
  ...
  for i := 1 to 4 do
  begin
    if Length(TrimLeft(R[i][1])) = 0 then
      R[i][1] := IntToStr(0);
    if Length(TrimLeft(R[i][2])) = 0 then
      R[i][2] := IntToStr(0);
  ...
  begin
    ...
    begin
      ...
      R[i][4] := IntToStr(Trunc((Abs(U[i] - dat[i]) - StrToFloat(R[i][3])) * 60));
    end
    else
    begin
      R[i][3] := IntToStr(Trunc(360 - Abs(U[i] - dat[i])));
      R[i][4] := IntToStr(Trunc((360 - Abs(U[i] - dat[i]) - StrToFloat(R[i][3])) * 60));
    end;
  end;
  ...
  begin
    ...
    R[4][4] := IntToStr(Round((Abs(q * U[4] - dat[4]) - StrToFloat(R[4][3])) * 60));
  end
  else
  begin
    R[4][3] := IntToStr(Trunc(360 - Abs(q * U[4] - dat[4])));
    R[4][4] := IntToStr(Round((360 - Abs(q * U[4] - dat[4]) - StrToFloat(R[4][3])) * 60));
  end;

  for i := 1 to 4 do
  begin
    for j := 1 to (6 - Length(TrimLeft(R[i][3]))) do
      R[i][3] := '  ' + R[i][3];
    for j := 1 to (2 - Length(TrimLeft(R[i][4]))) do
      R[i][4] := '  ' + R[i][4];
  end;

  for i := 1 to 3 do
  begin
    if (StrToFloat(R[i][3]) + StrToFloat(R[i][4]) / 60) <= 1.2 then
      R[i][5] := '✓'
    else
      R[i][5] := '✕';
  ...
  if (StrToFloat(R[4][3]) + StrToFloat(R[4][4]) / 60) <= 0.02 then
    R[4][5] := '✓'
  else
    R[4][5] := '✕';
  ...
  for i := 1 to (3 - Length(TrimLeft(R[1][1]))) do
    R[1][1] := '  ' + R[1][1];
  for i := 1 to (3 - Length(TrimLeft(R[2][1]))) do
    R[2][1] := '  ' + R[2][1];
  for i := 1 to (3 - Length(TrimLeft(R[3][1]))) do
    R[3][1] := '  ' + R[3][1];
  for i := 1 to (3 - Length(TrimLeft(R[4][1]))) do
    R[4][1] := '  ' + R[4][1];

  for i := 1 to (2 - Length(TrimLeft(R[1][2]))) do
    R[1][2] := '  ' + R[1][2];
  for i := 1 to (2 - Length(TrimLeft(R[2][2]))) do
    R[2][2] := '  ' + R[2][2];
  for i := 1 to (2 - Length(TrimLeft(R[3][2]))) do
    R[3][2] := '  ' + R[3][2];
  for i := 1 to (2 - Length(TrimLeft(R[4][2]))) do
    R[4][2] := '  ' + R[4][2];
  ...
  ShowMessage(
    ...
    'Магнитный азимут (1983 г.)      ' + R[3][1] + '° ' + R[3][2] + #39 + R[3][3] + '° ' + R[3][4] + #39 + R[3][5] + #13#10 +
...
procedure TFormcorners100k.Bznak2MouseEnter(Sender: TObject);
begin
  Bznak2.Glyph.LoadFromFile('..\data\ygli\assets\green/Flag22.bmp');
end;

procedure TFormcorners100k.Bznak2MouseLeave(Sender: TObject);
begin
  Bznak2.Glyph.LoadFromFile('..\data\ygli\assets\green/Flag21.bmp');
end;
...
procedure TFormcorners100k.Bznak4MouseEnter(Sender: TObject);
begin
  Bznak4.Glyph.LoadFromFile('..\data\ygli\assets\green/Flag42.bmp');
end;

procedure TFormcorners100k.Bznak4MouseLeave(Sender: TObject);
begin
  Bznak4.Glyph.LoadFromFile('..\data\ygli\assets\green/Flag41.bmp');
end;
